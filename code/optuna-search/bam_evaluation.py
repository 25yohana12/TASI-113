...
class EvalConfig:
    ...
    OUTPUT_PATH = "evaluation/bam_model_evaluation.json"
...
class BAMEvaluator:
    """
    Evaluator untuk modul BAM berdasarkan tiga metrik yang ditetapkan
    ...
    def __init__(self, config: EvalConfig):
        ...
        print(f"[*] Merging LoRA from {config.LORA_PATH}...")
    ...
    def run(self, mode: str = "prod", num_samples: int = None):
        ...
        # Laporan akhir
        print("\n" + "=" * 50)
        print("📊 RINGKASAN EVALUASI MODUL BAM")
        print("=" * 50)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Evaluator Modul BAM — EM | ROUGE-L (P/R/F1) | BERTScore (P/R/F1)"
    )
    parser.add_argument(
