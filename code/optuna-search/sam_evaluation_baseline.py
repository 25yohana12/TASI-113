...
class EvalConfig:
    ...
    OUTPUT_PATH    = "evaluation/sam_baseline_evaluation.json"
...
class SAMEvaluator:
    """
    Evaluator baseline untuk modul SAM (pure base model, tanpa LoRA).
    ...
    def run(self, mode: str = "prod", num_samples: int = None):
        ...
        # Laporan akhir
        print("\n" + "=" * 50)
        print("📊 RINGKASAN EVALUASI BASELINE SAM")
        print("=" * 50)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Evaluator Baseline SAM — EM | ROUGE-L (P/R/F1) | BERTScore (P/R/F1)"
    )
    parser.add_argument(
