"""
OPTUNA TUNING FOR LOM MODULE
==============================

SR Error Correction task optimization
...
CONFIG_FILE = "train_lom_sampling.yaml"
MODULE_NAME = "LOM"
RESULT_DIR = "tuning_results_lom"
PLOT_DIR = "plots_lom"
N_TRIALS = 30
...
def run_training(trial_num, config):
    ...
    output_dir = f"../../outputs/llamafactory-finetuning/lom_trial_{trial_num}"
    config["output_dir"] = output_dir
    
    # Create trial-specific config file
    trial_config_file = f"train_lom_trial_{trial_num}.yaml"
