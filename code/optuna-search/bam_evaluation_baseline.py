...
class EvalConfig:
    ...
    LORA_PATH      = "outputs/bam_model/"
    TEST_DATA_PATH = "dataset/bam_data/test.json"
    OUTPUT_PATH    = "evaluation/bam_baseline_evaluation.json"
...
# ==========================================
# 3. CORE EVALUATOR (PURE BASE MODEL / BASELINE)
# ==========================================
class BAMEvaluator:
    """
    Evaluator baseline untuk modul BAM (pure base model, tanpa LoRA).
    ...
    def prompt_phi4(self, item: Dict) -> str:
    ...
    def run(self, mode: str = "prod", num_samples: int = None):
        ...
        # Laporan akhir
        print("\n" + "=" * 50)
        print("📊 RINGKASAN EVALUASI BASELINE BAM")
        print("=" * 50)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Evaluator Baseline BAM — EM | ROUGE-L (P/R/F1) | BERTScore (P/R/F1)"
    )
    parser.add_argument(
    ...
    evaluator = BAMEvaluator(EvalConfig())
